...
{
    //splits
    int N = 900; // Длинна массива
    double a = 10, b = 50; // мин/макс
    int splits_cnt = 10; // количество промежутков
    ...
    char d;
    cout << "Введите символ заполнения гистограммы\n";
    cin >> d;
